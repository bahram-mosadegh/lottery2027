...
class CreateAdultChildrenTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('adult_children', function (Blueprint $table) {
            $table->id();
            ...
            $table->tinyInteger('independent_register')->default(0);
    ...
    {
        Schema::dropIfExists('adult_children');
    }
}
